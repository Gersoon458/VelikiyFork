...
ent-SignAnchor = знак «станционный якорь»
    .desc = Знак, указывающий на станционный якорь.
    .suffix = { "Знак ВД" }
...
ent-SignWarningAtmosAir = знак «внимание: Воздух»
    .desc = ВНИМАНИЕ! Труба для транспортировки воздуха. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosAmmonia = знак «внимание: Аммиак»
    .desc = ВНИМАНИЕ! Труба для транспортировки аммиака. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosBase = предупреждающий знак
    .desc = Это предупреждающий знак, но на нём нет текста.
    .suffix = { "" }

ent-SignWarningAtmosCO2 = знак «внимание: CО2»
    .desc = ВНИМАНИЕ! Труба для транспортировки CO2. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosSteam = знак «внимание: Водяной пар»
    .desc = ВНИМАНИЕ! Труба для транспортировки водяного пара. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosN2 = знак «внимание: N2»
    .desc = ВНИМАНИЕ! Труба для транспортировки азота. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosN2O = знак «внимание: N2O»
    .desc = ВНИМАНИЕ! Труба для транспортировки N2O. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosNothing = знак «внимание: Ничего»
    .desc = ВНИМАНИЕ! Труба для транспортировки ничего. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosO2 = знак «внимание: О2»
    .desc = ВНИМАНИЕ! Труба для транспортировки кислорода. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosPlasma = знак отходов плазмы
    .desc = ВНИМАНИЕ! Труба для транспортировки плазмы. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosTritium = знак отходов трития
    .desc = ВНИМАНИЕ! Труба для транспортировки трития. Перед работой убедитесь, что поток газа через неё отключен.
    .suffix = { "" }

ent-SignWarningAtmosText = предупреждающий знак с текстом
    .desc = Это предупреждающий знак с текстом, набранным мелким шрифтом.
    .suffix = { "" }

ent-SignWarningAtmosWaste = знак отходов атмоса
